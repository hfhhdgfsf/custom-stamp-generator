        new Vue({
            ...
            methods: {
                ...
                createSealCN(id){
                    ...
                    context.beginPath();
                    context.rect(30*this.sealScale06,60*this.sealScale06,100*this.sealScale06,40*this.sealScale06);  // ????(x, y, ??, ??)
                    context.stroke();
                    ...
                    for (var i = 0; i < count; i++) {
                        ...
                        context.save();
                        context.translate(60*this.sealScale06 + this.fontBorder01, 0);// ??????,????x???   
