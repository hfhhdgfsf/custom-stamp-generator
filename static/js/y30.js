       new Vue({
            ...
            methods: {
                ...
                createSealCN(id){
                    ...
                    context.beginPath();
                    context.rect(5*this.sealScale06,50*this.sealScale06,230*this.sealScale06,140*this.sealScale06);  // ????(x, y, ??, ??)
                    context.stroke();
                    context.save();
                    ...
                    context.font = 'bold ' + 20*this.sealScale06 + 'px ??' 
                    context.fillText('?',12*this.sealScale06,115*this.sealScale06)
                    context.fillText('?',12*this.sealScale06,135*this.sealScale06)
                    context.fillText('?',206*this.sealScale06,115*this.sealScale06)
                    context.fillText('?',206*this.sealScale06,135*this.sealScale06)
