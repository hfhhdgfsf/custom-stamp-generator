 new Vue({
            ...
            methods: {
                ...
                createSealCN(id,input01,input02,input03){
                    ...
                    if(this.checked06){
                        context.beginPath();
                        context.rect(canvas.width/2-(47-this.rectLeft06)*this.sealScale08,canvas.height/2-(-5-this.rectTop06)*this.sealScale08, (100+this.rectWidth06)*this.sealScale08, (15+this.rectHeight06)*this.sealScale08);  // ????(x, y, ??, ??)
