  new Vue({
            ...
            methods: {
                ...
                createSeal11(id) {
                    ...
                    var angle = 4 * Math.PI / (3 * count + 105 - this.fontGap01);// ????    0.75 <=> 5.1 ???????2.5:1
                    ...
                    var angle = 4 * Math.PI / (3 * count + 24 - this.fontGap02);// ????    0.75 <=> 5.1 ???????2.5:1
                    ...
                    for (var i = 0; i < count; i++) {
                        ...
                        if (i == 0) {
                            ...
                            context.rotate(angle);
                        context.save();
                        context.translate(64*this.sealScale09 + this.fontBorder02, 0);// ??????,????x???   
                        context.rotate(Math.PI / 2);// ??90?,?????x?   
                        context.fillText(c, 0, 5);// ????????   
                        context.restore();
                    }
