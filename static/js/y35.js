        new Vue({
            ...
            methods: {
                ...
                createSeal11(id) {
                    ...
                    // ?????
                    context.font = 'bold' + 30*this.sealScale09 + 'px ??';
                    ...
                    var angles = -4 * Math.PI / ((5-this.fontGap05*0.4) * (counts - 1));// ???? ----------11  0.4:0.05 [10.6:3.15]
                    ...
                    for (var i = 0; i < counts; i++) {
                        ...
                        context.save();
                        context.translate(66*this.sealScale09 + this.fontBorder05, 0);// ??????,????x???   
